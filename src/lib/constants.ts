...
export const UNIT_DATA: Record<string, Category> = {
  ...
  volume: {
    ...
    units: {
      ...
      us_gallon: { name: "US Gallons", factor: 3.78541 },
      us_quart: { name: "US Quarts", factor: 0.946353 },
      us_pint: { name: "US Pints", factor: 0.473176 },
      us_cup: { name: "US Cups", factor: 0.24 },
      us_fl_oz: { name: "US Fluid Ounces", factor: 0.0295735 },
    },
  },
  area: {
    name: "Area",
    ...
    units: {
      ...
      square_kilometer: { name: "Square Kilometers", factor: 1e6 },
      square_centimeter: { name: "Square Centimeters", factor: 1e-4 },
      hectare: { name: "Hectares", factor: 10000 },
      square_mile: { name: "Square Miles", factor: 2.59e6 },
      square_yard: { name: "Square Yards", factor: 0.836127 },
  ...
  speed: {
    ...
    units: {
      meter_per_second: { name: "Meters per second", factor: 1 },
      kilometer_per_hour: { name: "Kilometers per hour", factor: 0.277778 },
      mile_per_hour: { name: "Miles per hour", factor: 0.44704 },
  ...
  energy: {
    ...
    units: {
      ...
      kilowatt_hour: { name: "Kilowatt-hours", factor: 3.6e6 },
    },
  },
  temperature: {
    name: "Temperature",
